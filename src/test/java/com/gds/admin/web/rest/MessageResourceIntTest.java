...
public class MessageResourceIntTest {
     ...
     *
     * @see com.gds.admin.repository.search.MessageSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createMessage() throws Exception {
        ...
        assertThat(testMessage.getMessageKey()).isEqualTo(DEFAULT_MESSAGE_KEY);
        assertThat(testMessage.getMessageValue()).isEqualTo(DEFAULT_MESSAGE_VALUE);
    ...
    public void updateMessage() throws Exception {
        ...
        assertThat(testMessage.getMessageKey()).isEqualTo(UPDATED_MESSAGE_KEY);
        assertThat(testMessage.getMessageValue()).isEqualTo(UPDATED_MESSAGE_VALUE);
    ...
    public void searchMessage() throws Exception {
        ...
        restMessageMockMvc.perform(get("/api/_search/messages?query=id:" + message.getId()))
            ...
            .andExpect(jsonPath("$.[*].messageValue").value(hasItem(DEFAULT_MESSAGE_VALUE)))
